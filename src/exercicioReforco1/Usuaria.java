    ...
    public static void main(String[] args)
          {
              ...
              Estrutura arr = new Estrutura(maxSize);               Scanner entrada = new Scanner (System.in); //Instancio o objeto entrada do tipo Scanner
              ...
              int posicao = arr.findByIdade(entrada.nextLine());
